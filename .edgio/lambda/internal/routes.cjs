...
// node_modules/@edgio/nodejs-connector/NodejsRoutes.js
var require_NodejsRoutes = __commonJS({
  "node_modules/@edgio/nodejs-connector/NodejsRoutes.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.NodejsRoutes = void 0;
    var router_1 = require_router();
    var config_1 = require_config();
    var environment_1 = require_environment();
    var NodejsRoutes = class extends router_1.Router {
      onRegister(router) {
        var _a, _b;
        const edgioConfig = (0, config_1.getConfig)();
        ...
        if (((_a = edgioConfig.nodejsConnector) == null ? void 0 : _a.staticFolder) && (0, environment_1.isProductionBuild)()) {
          router.static((_b = edgioConfig.nodejsConnector) == null ? void 0 : _b.staticFolder);
        }
        router.use(router_1.edgioRoutes);
      }
    };
    exports2.NodejsRoutes = NodejsRoutes;
  }
});

// node_modules/@edgio/nodejs-connector/index.js
var require_nodejs_connector = __commonJS({
  "node_modules/@edgio/nodejs-connector/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.nodejsRoutes = void 0;
    var NodejsRoutes_1 = require_NodejsRoutes();
    exports2.nodejsRoutes = new NodejsRoutes_1.NodejsRoutes();
  }
});
...
var import_nodejs_connector = __toESM(require_nodejs_connector());
var routes_default = new import_router.Router().use(import_nodejs_connector.nodejsRoutes);
